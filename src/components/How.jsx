  ...
  return (
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 mx-auto text-center lg:mb-16 text-center">
          <h2 className="mb-4 text-4xl tracking-tight mx-auto font-extrabold text-black">
            How it works
          </h2>
        </div>
          ...
          {[
            {
              title: 'Marketing',
              icon: (
                <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
