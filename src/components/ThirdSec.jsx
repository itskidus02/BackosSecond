  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="flex gap-4 flex-col items-center w-2/4 text-center mx-auto">
        <div className="lg:text-[55px] md:text-[30px] text-[21px] text-[#2092CF]">
          Our platform makes scheduling simple
        </div>
        <div className="lg:text-[19px] md:text-[14px] text-[9px]">
        ...
        <div>
          <button className="bg-[#2092CF] text-white p-2 lg:px-14 px-2 text-sm rounded-sm">
            Register
          </button>
        </div>
      </div>
