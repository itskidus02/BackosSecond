...
<footer class="bg-[#DDF0FA]">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0 flex justify-start text-left flex-col gap-2">
    <a href="https://flowbite.com/" class="flex flex-col justify-start items-start gap-1">
        <img src={logo} class="h-12 me-3"/>
        <span class="text-3xl font-semibold whitespace-nowrap mt-3 text-black">Appoint</span>
        <span class="text-xl font-light ">Simplifying your booking experience <br /> with Seamless Appointments</span>
    </a>
</div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"> <a href="https://flowbite.com/" class="hover:underline">© 2024 Appoint Inc. All rights reserved.</a>
          </span>
